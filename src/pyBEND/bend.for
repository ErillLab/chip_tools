...
!-----------------------------------------------------------
	...
	real*4 twist(4,4),roll(4,4),tilt(4,4)
		...
		open(3,file='profile.log',form='FORMATTED',status='NEW')
		open(4,file='profile.ps',form='FORMATTED',status='NEW')
...
!Calculate trajectory of helix axis
		...
		!write(6, *) 'sequences: ', isequence(i), isequence(i+1)
		!write(6, *) 'twistsum += ', twist(isequence(i), isequence(i+1))
		!write(6, *) 'twistsum: ', twistsum
